...
my_qsort:
    ...
    /* r1 is nmemb */
    /* r2 is size */
    push {r4, r5, r10, fp, lr}     /* keep r4, r5, r10 and lr */

    mov fp, sp

    mov r5, #0                /* r5 ← 0 */
    str r5, [fp, #-4]         /* counter ← r5 */

    /* setup call to qsort */
    /* parameters r0 to r2 are already OK */
    ldr r3, addr_of_integer_comparison  /* r3 ← &integer_comparison
                                           compar */
 
    bl qsort                  /* call qsort */
   
    ldr r0, [fp, #-4]         /* r0 ← counter
                                 set result of the function */

    pop {r4, r5, r10, lr}      /* restore r4, r5, r10 and lr */
    bx lr
    ...
    integer_comparison:
        ...
        push {r4, r10, lr} /* keep r4, r5, fp and lr */
        ...
        pop {r4, r5, lr}  /* restore r4, r5, fp and lr */
        bx lr           /* return */
